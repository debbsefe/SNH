        ...
        if($currentUser){
          //check the user password.
            ...
            if($passwordFromDB == $passwrodFromUser){
                ...
                $_SESSION['registerDate'] = $userObject->registerDate;


                date_default_timezone_set("Africa/Lagos");
                $_SESSION['loginDateTime'] = date("l, jS F Y - g:i:s A");

                 // update last login 
                $userObject->lastLogin = $_SESSION['loginDateTime'];
                file_put_contents("db/users/".$currentUser->email . ".json", json_encode($userObject));
                // exit();
